        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsCorporateMember = table.Column<bool>(type: "BOOLEAN", nullable: false),
                    ...
                    ListingsRemainingThisMonth = table.Column<int>(type: "BOOLEAN", nullable: false),
                    TotalListingsAllowed = table.Column<int>(type: "BOOLEAN", nullable: false),
                    FeaturedListingsIncluded = table.Column<int>(type: "BOOLEAN", nullable: false),
                    FeaturedListingsUsed = table.Column<int>(type: "BOOLEAN", nullable: false),
                    VitrinListingsIncluded = table.Column<int>(type: "BOOLEAN", nullable: false),
                    VitrinListingsUsed = table.Column<int>(type: "BOOLEAN", nullable: false),
                    IsCorporateApproved = table.Column<bool>(type: "BOOLEAN", nullable: false),
                    ...
                    AccessFailedCount = table.Column<int>(type: "BOOLEAN", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TradeIn = table.Column<bool>(type: "BOOLEAN", nullable: false),
                    ...
                    CoverImageIndex = table.Column<int>(type: "BOOLEAN", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DurationDays = table.Column<int>(type: "BOOLEAN", nullable: false),
                    ListingsIncluded = table.Column<int>(type: "BOOLEAN", nullable: false),
                    Description = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    IsActive = table.Column<bool>(type: "BOOLEAN", nullable: false),
                    DisplayOrder = table.Column<int>(type: "BOOLEAN", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "BOOLEAN", nullable: false)
                        ,
                    UserId = table.Column<string>(type: "TEXT", nullable: false),
                    PackageId = table.Column<int>(type: "BOOLEAN", nullable: false),
                    TotalPurchased = table.Column<int>(type: "BOOLEAN", nullable: false),
                    UsedCount = table.Column<int>(type: "BOOLEAN", nullable: false),
